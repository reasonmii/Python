...
- Use the reverse parameter in sorted() to sort the dictionary
  in reverse order, based on the second argument

https://www.30secondsofcode.org/python/s/sort-dict-by-key
'''
